...
def display_logo(size="medium"):
    ...
    if os.path.exists(logo_path):
        ...
        st.markdown(f'''
            <div style="display: flex; justify-content: center; align-items: center; margin: 0 auto 10px auto; width: 100%; text-align: center; position: relative;">
                <img src="data:image/png;base64,{logo_b64}" 
                     width="{config["width"]}" 
                     style="max-width: 100%; height: auto; pointer-events: none; margin: 0 auto; display: block; position: relative; left: 50%; transform: translateX(-50%);">
            </div>
